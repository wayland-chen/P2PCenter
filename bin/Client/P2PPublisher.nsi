...
InstallDir "$PROGRAMFILES\Kan8888_P2P发布端"
...
Section "MainSection" SEC01
  ...
  CreateDirectory "$SMPROGRAMS\Kan8888_P2P发布端"
  CreateShortCut "$SMPROGRAMS\Kan8888_P2P发布端\Kan8888_P2P发布端.lnk" "$INSTDIR\P2POrderClient.exe"
  CreateShortCut "$SMPROGRAMS\Kan8888_P2P发布端\卸载.lnk" "$INSTDIR\uninst.exe"
  CreateShortCut "$DESKTOP\Kan8888_P2P发布端.lnk" "$INSTDIR\P2POrderClient.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\Kan8888_P2P发布端.lnk"
  Delete "$SMPROGRAMS\Kan8888_P2P发布端\Kan8888_P2P发布端.lnk"
  Delete "$SMPROGRAMS\Kan8888_P2P发布端\卸载.lnk"
  RMDir "$SMPROGRAMS\Kan8888_P2P发布端"
